...
!(function (e, t) {
  ...
  function O(e, t, u) {
    var n = t.href,
      ...
      t = e[1].replace(/\\([\[\]])/g, "$1");
    return "!" !== e[0].charAt(0)
      ? { type: "link", raw: u, href: n, title: r, text: t }
      : { type: "image", raw: u, href: n, title: r, text: q(t) };
  }
  (_ = (function () {
    function e(e) {
      this.options = e || T;
    ...
    return (
      ...
      (t.heading = function (e) {
        ...
        if (t) {
          ...
          return (
            ...
            { type: "heading", raw: t[0], depth: t[1].length, text: u }
          );
        }
      }),
            ...
            if (
              ...
              this.options.pedantic ||
                ((s = t.match(
                  ...
                  ((u = t.length - s.index + c.slice(f + 1).join("\n").length),
                  (D.raw = D.raw.substring(0, D.raw.length - u)),
                  (l = t = t.substring(0, s.index)),
                  (p = f + 1))),
              f !== p - 1)
            ) {
              if (
                ...
                this.options.pedantic
                  ? n[1].length > g[1].length
                  : n[1].length >= g[0].length || 3 < n[1].length)
              ) {
                c.splice(
                  f,
                  2,
        ...
        if (e)
          return (
            !t && /^<a /i.test(e[0])
              ? (t = !0)
              : t && /^<\/a>/i.test(e[0]) && (t = !1),
            !u && /^<(pre|code|kbd|script)(\s|>)/i.test(e[0])
              ? (u = !0)
              : u && /^<\/(pre|code|kbd|script)(\s|>)/i.test(e[0]) && (u = !1),
            {
      ...
      (t.autolink = function (e, t) {
        ...
        if (e) {
          var u,
            t =
              "@" === e[2]
                ? "mailto:" + (u = q(this.options.mangle ? t(e[1]) : e[1]))
                : (u = q(e[1]));
          return {
            type: "link",
            raw: e[0],
      ...
      (t.url = function (e, t) {
        ...
        if ((u = this.rules.inline.url.exec(e))) {
          if ("@" === u[2])
            r = "mailto:" + (n = q(this.options.mangle ? t(u[0]) : u[0]));
          else {
            for (
              ;
              (i = u[0]),
          ...
          u = t
            ? this.options.sanitize
              ? this.options.sanitizer
                ...
                : q(e[0])
              : e[0]
            : q(this.options.smartypants ? u(e[0]) : e[0]);
          return { type: "text", raw: e[0], text: u };
        }
      }),
      e
    );
  ...
  (b.def = z(b.def)
    ...
    (b.bullet = /(?:[*+-]|\d{1,9}[.)])/),
    (b.item = /^( *)(bull) ?[^\n]*(?:\n(?! *bull ?)[^\n]*)*/),
    (b.item = z(b.item, "gm").replace(/bull/g, b.bullet).getRegex()),
  ...
  var y = (function () {
      function u(e) {
        ...
        e = { block: P.normal, inline: L.normal };
        this.options.pedantic
          ? ((e.block = P.pedantic), (e.inline = L.pedantic))
          : this.options.gfm &&
            ((e.block = P.gfm),
            this.options.breaks ? (e.inline = L.breaks) : (e.inline = L.gfm)),
          ...
          for (
            ...
            if (
              ...
              if ((u = this.tokenizer.space(r)))
                ...
                (r = r.substring(u.raw.length)), t.push(u);
              else if ((u = this.tokenizer.nptable(r)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if ((u = this.tokenizer.hr(r)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if ((u = this.tokenizer.blockquote(r)))
                (r = r.substring(u.raw.length)),
                  (u.tokens = this.blockTokens(u.text, [], e)),
                  t.push(u);
              else if ((u = this.tokenizer.list(r))) {
                for (
                  r = r.substring(u.raw.length), i = u.items.length, n = 0;
                  n < i;
                  n++
                )
                ...
                (r = r.substring(u.raw.length)), t.push(u);
              else if (e && (u = this.tokenizer.def(r)))
                (r = r.substring(u.raw.length)),
                ...
                this.options.extensions &&
                  ...
                  (function () {
                    ...
                    o.options.extensions.startBlock.forEach(function (e) {
                      "number" == typeof (t = e.call(this, n)) &&
                        0 <= t &&
                        (u = Math.min(u, t));
                    }),
                      u < 1 / 0 && 0 <= u && (l = r.substring(0, u + 1));
                  })(),
                e && (u = this.tokenizer.paragraph(l)))
              )
                (s = t[t.length - 1]),
                  a && "paragraph" === s.type
                    ? ((s.raw += "\n" + u.raw), (s.text += "\n" + u.text))
            ...
            switch ((i = e[l]).type) {
              ...
              case "table":
                for (
                  ...
                  (i.tokens.header[t] = []),
                    this.inlineTokens(i.header[t], i.tokens.header[t]);
                for (n = i.cells.length, t = 0; t < n; t++)
                  for (
                    r = i.cells[t], i.tokens.cells[t] = [], u = 0;
                    u < r.length;
                    u++
                  )
                    (i.tokens.cells[t][u] = []),
                      this.inlineTokens(r[u], i.tokens.cells[t][u]);
                break;
              case "blockquote":
        ...
        (n.inlineTokens = function (r, t, e, u) {
          ...
          if (this.tokens.links) {
            ...
            if (0 < h.length)
              for (
                ;
                null != (a = this.tokenizer.rules.inline.reflinkSearch.exec(c));
          ...
          for (
            ;
            null != (a = this.tokenizer.rules.inline.escapedEmSt.exec(c));
            ...
            if (
              ...
              !(
                ...
                this.options.extensions.inline.some(function (e) {
                  return (
                    !!(n = e.call(l, r, t)) &&
                    ((r = r.substring(n.raw.length)), t.push(n), !0)
                  );
                })
              ))
            )
              if ((n = this.tokenizer.escape(r)))
                (r = r.substring(n.raw.length)), t.push(n);
              else if ((n = this.tokenizer.tag(r, e, u)))
                (r = r.substring(n.raw.length)),
                  ...
                  "text" === i.type
                    ...
                    : t.push(n);
              else if ((n = this.tokenizer.link(r)))
                (r = r.substring(n.raw.length)),
                  "link" === n.type &&
                    (n.tokens = this.inlineTokens(n.text, [], !0, u)),
                  t.push(n);
                ...
                (r = r.substring(n.raw.length)),
                  ...
                  "link" === n.type
                    ...
                    : i && "text" === n.type && "text" === i.type
                      ? ((i.raw += n.raw), (i.text += n.text))
                      : t.push(n);
              else if ((n = this.tokenizer.emStrong(r, c, D)))
                (r = r.substring(n.raw.length)),
                  (n.tokens = this.inlineTokens(n.text, [], e, u)),
                  t.push(n);
              else if ((n = this.tokenizer.codespan(r)))
                (r = r.substring(n.raw.length)), t.push(n);
              else if ((n = this.tokenizer.br(r)))
                (r = r.substring(n.raw.length)), t.push(n);
              else if ((n = this.tokenizer.del(r)))
                (r = r.substring(n.raw.length)),
                  (n.tokens = this.inlineTokens(n.text, [], e, u)),
                  t.push(n);
              else if ((n = this.tokenizer.autolink(r, X)))
                (r = r.substring(n.raw.length)), t.push(n);
              else if (e || !(n = this.tokenizer.url(r, X))) {
                if (
                  ((s = r),
                  this.options.extensions &&
                  ...
                  (n = this.tokenizer.inlineText(s, u, N)))
                )
                  (r = r.substring(n.raw.length)),
                    "_" !== n.raw.slice(-1) && (D = n.raw.slice(-1)),
                    (o = !0),
                ...
                case "table":
                  for (l = D = "", r = o.header.length, u = 0; u < r; u++)
                    l += this.renderer.tablecell(
                      this.parseInline(o.tokens.header[u]),
                  ...
                  for (
                    ...
                    for (
                      l = "", i = (s = o.tokens.cells[u]).length, n = 0;
                      n < i;
                      n++
                    )
                      l += this.renderer.tablecell(this.parseInline(s[n]), {
                        header: !1,
                        align: o.align[n],
                      });
          ...
          switch ((l(t), t.type)) {
            ...
            default:
              ...
              ae.defaults.extensions.childTokens[t.type]
                ? ae.defaults.extensions.childTokens[t.type].forEach(
                    function (e) {
                      ae.walkTokens(t[e], l);
                    },
                  )
